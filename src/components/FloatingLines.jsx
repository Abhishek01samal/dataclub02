...
export default function FloatingLines({
  ...
  // Disable mouse-based effects on touch-only devices — no cursor to track
  const isTouchDevice = typeof window !== 'undefined' && window.matchMedia('(hover: none)').matches;
  const effectiveInteractive = interactive && !isTouchDevice;
  const effectiveParallax = parallax && !isTouchDevice;
  ...
  useEffect(() => {
    ...
    // Cap at 1 on mobile (saves 2–4× GPU fill), 1.5 on desktop
