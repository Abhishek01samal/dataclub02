...
export function initSMyWay(el: HTMLElement) {
  new Section(el)
}
  ...
  class Section {
    ...
    constructor(el: HTMLElement) {
      ...
      Array.from(this.objectsWrapper.children).forEach((el) => {
        this.objects.push(new PhysObject(el, this))
      })
    ...
    onIntersect(e: Event) {
      ...
      this.canThrow = ce.detail.isIntersecting
     ...
     * Object move end
     */
    objectMoveEnd(object: PhysObject) {
