...
import Noise from '@clone/utils/Noise'

export class AWaves extends HTMLElement {
  svg!: SVGElement
  ...
  drawLines() {
    ...
    lines.forEach((points, lIndex) => {
      ...
      points.forEach((p1pt: any, pIndex: number) => {
        const isLast = pIndex === points.length - 1

        p1 = this.moved(p1pt, !isLast)
